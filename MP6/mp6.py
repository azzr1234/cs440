...
def main(args):
    ...
    print('PART1 train_set=',train_set.size())
    train_labels = torch.tensor(train_labels,dtype=torch.int64)
    print('PART1 train_label=',train_labels.size())
    dev_set      = torch.tensor(dev_set,dtype=torch.float32)
    print('PART 1 DEV_SETsize=',dev_set.shape)
    ...
    train_set    = torch.tensor(train_set,dtype=torch.float32)
    print('PART2 train_set=',train_set.size())
    train_labels = torch.tensor(train_labels,dtype=torch.int64)
    print('PART2 train_label=',train_labels.size())
    dev_set      = torch.tensor(dev_set,dtype=torch.float32)
    print('PART 2 DEV_SETsize=',dev_set.shape)
