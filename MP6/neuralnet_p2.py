...
class NeuralNet(torch.nn.Module):
    def __init__(self, lrate,loss_fn,in_size,out_size):
        ...
        """
        #referencing the neural network structure on https://medium.com/ml2vec/intro-to-pytorch-with-image-classification-on-a-fashion-clothes-dataset-e589682df0c5
        ...
        self.layer4=nn.Conv2d(16, 32, kernel_size=5, padding=2)
        self.layer5=nn.BatchNorm2d(32)
        self.fc = nn.Linear(7*7*32, 5)
        self.optimizer=optim.Adam(self.get_parameters(),lr=lrate, weight_decay=0.01)#weight_decay reflects l2-norm
    ...
    def step(self, x,y):
        ...
        print('y size',y.size(),'predict size',predict.size())
        L.backward()
        self.optimizer.step()
        return L.data.item() 
...
def fit(train_set,train_labels,dev_set,n_iter,batch_size=100):
    ...
    #print('lrate=',lrate,'time used',end-start)
