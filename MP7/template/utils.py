...
def hyperparameters():
    ...
    parser.add_argument('--epsilon', type=float, default=0.2, help='exploration parameter')#0.2 for DQN 0.8 FOR TABULAR
...
def rollout(env: gym.Env, policies: policies.QPolicy, episodes: int, temp: float, render: bool = True):
    """
